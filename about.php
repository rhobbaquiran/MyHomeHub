    ...
    <div class="services-wrapper mt-5 mb-5">
        <div class="card">
            <div class="row no-gutters">
                <div class="col-md-6">
                    <img src="../myhomehub/includes/myhomehub_logo_bg.jpeg" alt="Image" class="card-img">
                </div>
                <div class="col-md-6">
                    <div class="card-body">
                        <h2 class="card-title mb-4">We are MyHomeHub</h2>
                        <p class="card-text">MyHomeHub aim to provide a platform that makes it as simple and convenient for landlords and residents. 
                            Founded in 2023.
                        </p>
                        <br>
                        <p class="card-text">We seek to enhance the management experience overall by replacing the traditional way of 
                            residential management with an automated solution.
                        </p>
                    </div>
                </div>
            </div>
