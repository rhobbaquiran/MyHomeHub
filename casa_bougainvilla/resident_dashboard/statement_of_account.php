...
if (isset($_POST['searchButton'])) {
    ...
    if (!empty($searchInput) && !empty($_SESSION['account_number'])) {
        ...
        $search_query = "SELECT * FROM resident_transactions WHERE (account_number LIKE ? OR username LIKE ? OR bill_number LIKE ? OR status LIKE ?  OR billing_period_start LIKE ? OR billing_period_end LIKE ? OR due_date LIKE ?) AND is_deleted = 0 AND account_number = ?";
...
<body>
    ...
    <div class="container">
        <button class="btn btn-primary mx-5 my-5"><a href="bill_payment.php" class="text-light">Pay Bill</a></button>
        ...
        <div class="container mt-3">
            <div class="row">
                <div class="col-md-6 offset-md-3">
                    <form method="post" action="statement_of_account.php">
        ...
        <div class="pagination justify-content-center mt-3">
            <ul class="pagination">
                <?php
                $total_pages_query = "SELECT COUNT(*) as total FROM resident_transactions WHERE is_deleted = 0";
                ...
                for ($i = 1; $i <= $total_pages; $i++) {
                    echo '<li class="page-item ' . ($i == $current_page ? 'active' : '') . '"><a class="page-link" href="statement_of_account.php?page=' . $i . '">' . $i . '</a></li>';
                }
                ?>
            </ul>
        </div>
