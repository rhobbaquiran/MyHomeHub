...
if (isset($_POST['searchButton'])) {
    ...
    if (!empty($searchInput)) {
        ...
        $search_query = "SELECT u.*, c.name AS condominium_name 
                        ...
                        AND u.role = 'Tenant' AND c.name = 'Casa Bougainvilla'
...
if (isset($_GET['redeploy_id'])) {
    ...
    if ($stmt->affected_rows > 0) {
        $_SESSION['success'] = 'Tenant Reinstated successfully.';
        // Log the activity
        logActivity($_SESSION['username'], "Reinstated Tenant: $name. Reason: $reinstatement_reason");
        ...
        $_SESSION['error'] = 'Error Reinstated Tenant: ' . $stmt->error;
    }
...
// Display tenants with pagination
$sql = "SELECT u.*, c.name AS condominium_name 
        FROM users u
        LEFT JOIN condominiums c ON u.condominium_id = c.id
        WHERE u.role = 'Tenant' AND c.name = 'Casa Bougainvilla'
        LIMIT $offset, $rowsPerPage";

$result = $mysqli->query($sql);

// Total Pages Calculation
$totalRows = $mysqli->query("SELECT COUNT(*) as count FROM users WHERE role = 'Tenant' AND condominium_id = $condominium_id")->fetch_assoc()['count'];
...
<body>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="reportModalLabel">Tenants Leave Report</h5>
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tbody id="suspendedAccountsTableBody">
                                ...
                                $queryUsers = "SELECT account_number, username AS name, email, role, suspended, suspend_timestamp FROM users WHERE role = 'Tenant' AND condominium_id = $condominium_id";
                                ...
                                if ($resultUsers && $resultUsers->num_rows > 0) {
                                    ...
                                    echo "<div style='text-align: left; color: red;'><strong>Percentage of Suspended Tenants: " . number_format($percentageSuspended, 2) . "%</strong></div>";
                                    echo "&nbsp;<div style='text-align: left; color: green;'><strong>Percentage of Non-Suspended Tenants: " . number_format($percentageNonSuspended, 2) . "%</strong></div>";
                                    echo "</div>";
                                } else {
    ...
    <div class="container">
        <button class="btn btn-primary mx-5 my-5"><a href="add_tenant.php" class="text-light">Add
                Tenant</a></button>
        ...
        <div class="print-section">
            ...
            if (isset($search_result) && $search_result->num_rows > 0) {
                ...
                while ($row = $search_result->fetch_assoc()) {
                    ...
                    // Update button
                    echo '<button class="btn btn-primary"><a href="update_tenant.php?updateid=' . $id . '" class="text-light">Update</a></button>';
                    ...
                    if ($suspended == 1) {
                        ...
                        echo '<button class="btn btn-danger"><a href="suspend_tenant.php?suspendid=' . $id . '" class="text-light">Suspend</button></td></tr>';
                    }
            ...
            <h2 class="mt-4 mb-3" style="white-space: nowrap; text-align: center;">Tenants List</h2>
    ...
    <script>
        ...
        document.querySelectorAll('.action-buttons .btn-danger').forEach(button => {
            button.addEventListener('click', function () {
                ...
                // Redirect to suspend_tenant.php with the condominium ID
                window.location = "suspend_tenant.php?suspendid=" + id;
            });
        });
        ...
        function confirmRedeploy(id) {
            ...
            if (reinstateReason.trim() === "") {
                ...
                let confirmMessage = "Are you sure you want to Reinstate this Tenant?\n\nReinstatement Reason: " + reinstateReason;
                if (confirm(confirmMessage)) {
                    window.location = "resident_dashboard.php?redeploy_id=" + id + "&reinstatement_reason=" + encodeURIComponent(reinstateReason);
                }
            }
        }
