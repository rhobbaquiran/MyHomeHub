...
if (isset($_POST['searchButton'])) {
    ...
    if (!empty($searchInput)) {
        ...
        $search_query = "SELECT * FROM tenant_transactions WHERE (account_number LIKE ? OR username LIKE ? OR bill_number LIKE ? OR status LIKE ?  OR billing_period_start LIKE ? OR billing_period_end LIKE ? OR due_date LIKE ?) AND is_deleted = 0 ORDER BY FIELD(status, 'Pending') DESC, id DESC LIMIT $offset, $rowsPerPage";
...
if (isset($_GET['deleteid'])) {
    ...
    $select_query = "SELECT bill_number, username FROM tenant_transactions WHERE id = ? AND is_deleted = 0";
    ...
    // Soft Delete record in the resident_transactions table
    $update_query = "UPDATE tenant_transactions SET is_deleted = 1 WHERE id = ? AND is_deleted = 0";
    ...
    if ($stmt->affected_rows > 0) {
        ...
        logActivity($_SESSION['username'], "Deleted transaction of $username with Bill Number: $bill_number", $condominium_id);
    } else {
    ...
    header("Location: transactions.php?page=$page");
    exit();
}
?>
...
<body>
    ...
    <div class="container">
        <button class="btn btn-primary mx-5 my-5"><a href="add_transaction.php" class="text-light">Add Bill</a></button>
            ...
            <div class="modal-dialog modal-custom" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        $monthly_sql = "SELECT MONTH(due_date) as month, bill_number, username, account_number, total_amount_due 
                FROM tenant_transactions 
                WHERE is_deleted = 0 AND status = 'Paid' ORDER BY MONTH(due_date)";
                        ...
                        foreach ($monthlyData as $month => $data) {
                            ...
                            echo '<th scope="col" style="white-space: nowrap; text-align: center;">Resident</th>';
                            ...
                            foreach ($data as $row) {
                                ...
                                echo '<td style="white-space: nowrap; text-align: center;">' . $row['username'] . '</td>';
        ...
        <div class="print-section">
            ...
            if (isset($search_result) && $search_result->num_rows > 0) {
                ...
                echo '<thead>';
                echo '<tr>';
                echo '<th scope="col" style="white-space: nowrap;"><center>Bill Number</center></th>';
                echo '<th scope="col" style="white-space: nowrap;"><center>Resident</center></th>';
                echo '<th scope="col" style="white-space: nowrap;"><center>Account Number</center></th>';
                echo '<th scope="col" style="white-space: nowrap;"><center>Billing Period Start</center></th>';
                echo '<th scope="col" style="white-space: nowrap;"><center>Billing Period End</center></th>';
                echo '<th scope="col" style="white-space: nowrap;"><center>Due Date</center></th>';
                echo '<th scope="col" style="white-space: nowrap;"><center>Total Amount Due (Php)</center></th>';
                echo '<th scope="col" style="white-space: nowrap;"><center>Status</center></th>';
            ...
            <th scope="row"><center>' . $account_number . '</center></th>
            ...
            <div class="list-of-sales second-table">
                <h2 class="mt-4 mb-3" style="white-space: nowrap; text-align: center;">Tenants' Bills</h2>
                <table id="TableSorter2" class="table col-mx-5">
                    ...
                    <tbody>
                        ...
                        $sql = "SELECT id, account_number, username, bill_number, billing_period_start, billing_period_end, due_date, total_amount_due, status FROM tenant_transactions WHERE is_deleted = 0 ORDER BY FIELD(status, 'Pending') DESC, id DESC LIMIT $offset, $rowsPerPage";
            ...
            <ul class="pagination justify-content-center">
                <?php
                $totalRows = $mysqli->query("SELECT COUNT(*) as count FROM tenant_transactions WHERE is_deleted = 0")->fetch_assoc()['count'];
