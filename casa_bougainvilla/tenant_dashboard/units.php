...
if (isset($_POST['searchButton'])) {
    ...
    if (!empty($searchInput)) {
        ...
        $search_query = "SELECT * FROM units WHERE is_deleted = 0 AND tenant_id = ? AND (unit_number LIKE ? OR unit_status LIKE ?) LIMIT ?, ?";
        ...
        $stmt_search->bind_param("sssii", $tenant_id, $searchInput, $searchInput, $offset, $rowsPerPage);
        $stmt_search->execute();
...
if (isset($_GET['deleteid'])) {
    ...
    $select_query = "SELECT unit_number, tenant_id FROM units WHERE id = ? AND is_deleted = 0";
    ...
    $update_query = "UPDATE units SET is_deleted = 1 WHERE id = ? AND is_deleted = 0 AND tenant_id = ?";
    ...
    <div class="container">
        ...
        <th scope="row" style="white-space: nowrap; text-align: center;"><center>' . $unit_number . '</center></th>
            ...
            <div class="list-of-sales second-table">
                ...
                <table id="TableSorter2" class="table col-mx-5">
                    ...
                    <tbody>
                        ...
                        $sql = "SELECT * FROM units WHERE is_deleted = 0 AND tenant_id = ? LIMIT ?, ?";
            ...
            <ul class="pagination justify-content-center">
                <?php
                $totalRows = $search_result->num_rows ?? $mysqli->query("SELECT COUNT(*) as count FROM units WHERE is_deleted = 0 AND tenant_id = '{$_SESSION['username']}'")->fetch_assoc()['count'];
