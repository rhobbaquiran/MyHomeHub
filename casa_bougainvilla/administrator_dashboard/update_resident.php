...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($stmt->affected_rows > 0) {
        ...
        // Log the activity
        logActivity($_SESSION['username'], "Updated Resident: $name");
    } else {
        $_SESSION['error'] = 'Error updating Resident: ' . $stmt->error;
    }
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 offset-md-4 form">
                <form action="update_resident.php?updateid=<?php echo $update_id; ?>" method="post"
                    enctype="multipart/form-data">

                    <h2 class="text-center">Update Resident</h2><br>
