...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($stmt->affected_rows > 0) {
        $_SESSION['success'] = 'Front Desk updated successfully.';
        // Log the activity
        logActivity($_SESSION['username'], "Updated Front Desk: $name");
    } else {
        $_SESSION['error'] = 'Error updating Front Desk: ' . $stmt->error;
    }
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 offset-md-4 form">
                <form action="update_employee.php?updateid=<?php echo $update_id; ?>" method="post"
                    enctype="multipart/form-data">

                    <h2 class="text-center">Update Front Desk</h2><br>
