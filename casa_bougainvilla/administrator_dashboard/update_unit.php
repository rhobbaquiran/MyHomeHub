...
$select_query = "SELECT unit_number, unit_status, resident_id FROM units WHERE id = ?";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $newResidentUsername = trim($_POST['resident']);
    ...
    $update_query = "UPDATE units SET unit_number = ?, unit_status = ?, resident_id = ? WHERE id = ?";
    $stmt_update = $mysqli->prepare($update_query);
    $stmt_update->bind_param("sssi", $newUnitNumber, $newStatus, $newResidentUsername, $update_id);
    $stmt_update->execute();
        ...
        <div class="row">
            <div class="col-md-4 offset-md-4 form">
                <form action="update_unit.php?updateid=<?php echo $update_id; ?>" method="post"
                    ...
                    <h2 class="text-center">Update Unit</h2><br>
