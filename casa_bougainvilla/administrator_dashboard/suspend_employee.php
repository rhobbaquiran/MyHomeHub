...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($reason_suspend) || ($reason_suspend == "Non-Payment of Fees" && empty($selected_month)) || ($reason_suspend == "Others" && empty($reason_other))) {
        ...
        if ($stmt_update->affected_rows > 0) {
            $_SESSION['success'] = 'Front Desk suspended successfully.';
            // Log the activity
            logActivity($_SESSION['username'], "Suspended Front Desk: $name. Reason: $chosen_reason", $suspend_id);
            ...
            $_SESSION['error'] = 'Error Suspending Front Desk: ' . $stmt_update->error;
        }
...
<head>
    <meta charset="UTF-8">
    <title>Suspend Front Desk</title>
    <!-- Bootstrap CSS -->
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 offset-md-3 form">
                <form action="suspend_employee.php?suspendid=<?php echo $suspend_id; ?>" method="post"
                    enctype="multipart/form-data">

                    <h2 class="text-center">Suspend Front Desk</h2><br>
                    ...
                    <div class="form-group">
                        ...
                        <input type="radio" name="suspend_reason" value="Others"> Others
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function updateTextareaVisibility() {
                othersTextarea.style.display = (radioButtons[3].checked) ? 'block' : 'none';
            }
