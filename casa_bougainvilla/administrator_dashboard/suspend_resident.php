...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($reason_suspend) || ($reason_suspend == "Non-Payment of Fees" && empty($selected_month)) || ($reason_suspend == "Others" && empty($reason_other))) {
        ...
        if ($stmt_update->affected_rows > 0) {
            $_SESSION['success'] = 'Resident suspended successfully.';
            // Log the activity
            logActivity($_SESSION['username'], "Suspended Resident: $name. Reason: $chosen_reason", $suspend_id);
            ...
            $_SESSION['error'] = 'Error Suspending Resident: ' . $stmt_update->error;
        }
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 offset-md-3 form">
                <form action="suspend_resident.php?suspendid=<?php echo $suspend_id; ?>" method="post"
                    enctype="multipart/form-data">

                    <h2 class="text-center">Suspend Resident</h2><br>
