...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $role = 'Resident';  // Set the role to 'Resident'
    ...
    if ($password !== $confirm_password) {
        ...
        echo "  window.location = 'add_resident.php';";
        echo "}";
        echo "</script>";
        exit();
    }
    ...
    $dashboard_url = ($role === 'Resident') ? 'casa_bougainvilla/resident_dashboard/resident_dashboard.php' : '';
    ...
    if ($stmt->errno === 0) {
        ...
        // Log the activity
        logActivity($_SESSION['username'], "Added Resident: $name");
        ...
        $_SESSION['error'] = 'Error adding Resident: ' . $stmt->error;
    }
        ...
        <div class="row">
            <div class="col-md-4 offset-md-4 form">
                <form action="add_resident.php" method="post" enctype="multipart/form-data">
                    ...
                    <h2 class="text-center">Add Resident</h2><br>
