...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($reason_suspend) || ($reason_suspend == "Non-Payment of Fees" && empty($selected_month)) || ($reason_suspend == "Others" && empty($reason_other))) {
        ...
        if ($stmt_update->affected_rows > 0) {
            $_SESSION['success'] = 'Administrator suspended successfully.';
            
            // Log the activity
            logActivity($_SESSION['username'], "Suspended Administrator: $name. Reason: $chosen_reason", $suspend_id);
            ...
            $_SESSION['error'] = 'Error Suspending Administrator: ' . $stmt_update->error;
        }

        $stmt_update->close();

        // Redirect back to the administrators page
        header("Location: administrators.php");
        exit();
    }
}
...
<head>
    <meta charset="UTF-8">
    <title>Suspend Administrator</title>
    <!-- Bootstrap CSS -->
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 offset-md-3 form">
                <form action="suspend_administrator.php?suspendid=<?php echo $suspend_id; ?>" method="post" enctype="multipart/form-data">

                    <h2 class="text-center">Suspend Administrator</h2><br>
                    ...
                    <div class="form-group">
                        ...
                        <input type="radio" name="suspend_reason" value="Termination of Contract"> Termination of Contract<br>
                        <input type="radio" name="suspend_reason" value="Expired Contract"> Expired Contract<br>

                        <input type="radio" name="suspend_reason" value="Non-Payment of Fees"> Non-Payment of Fees for the Month of:
